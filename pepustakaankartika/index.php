  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">NurTriHadi</div>
        <div class="card-body">
          <h5 class="card-title">Smk Kartika XX-1 Makassar</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">Jl. Urip Sumoharjo, Tello Baru, Kec. Panakkukang, Kota Makassar, Sulawesi Selatan 90233</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">NurTriHadi</a>  2023</p>
        </div>
      </div>
    </footer>
